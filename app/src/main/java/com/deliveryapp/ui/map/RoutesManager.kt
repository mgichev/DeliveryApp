...
class RoutesManager(private val mapView: MapView, private val context: Context) {
    ...
    fun drawNextRoutePart() {
        if (fullRoutePoints.getOrNull(lastDrawRouteID + 1) == null)
            ...
            routePoints = listOf(fullRoutePoints.get(lastDrawRouteID),
                fullRoutePoints.get(lastDrawRouteID + 1))
            lastDrawRouteID++
        }
    }
